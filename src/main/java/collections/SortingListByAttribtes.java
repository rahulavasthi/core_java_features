...
public class SortingListByAttribtes {
	public static void main(String[] args) {
        ...
        System.out.println("\n*** After sorting without chain:");
        
        Collections.sort(listEmployees, new EmployeeWithoutChainedComparator());
...
//Without chain comparator
class EmployeeWithoutChainedComparator implements Comparator<Employee> {
	 
    @Override
    public int compare(Employee emp1, Employee emp2) {
    	int result1 = emp1.getJobTitle().compareTo(emp2.getJobTitle());
    	if (result1 == 0){
    		int result2 = emp1.getAge() - emp2.getAge();
    		if (result2 == 0){
